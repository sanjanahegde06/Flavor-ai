              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row gap-2 items-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="animate-bounce bg-gray-800 hover:bg-gray-900 text-white px-4 py-1 rounded-full text-sm font-semibold shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4"
